  ...
  public function UpdateEstadoVacante(){
    ...
    foreach ($vacante as $vac) {
        ...
        foreach ($ejecutar2 as $vac) {
         $sql="INSERT INTO tbl_vacante (`id_vacante`, `vac_nombre`, `vac_descripcion`, `vac_jornada_laboral`, `vac_tipo_contrato`, `vac_salario`, `vac_fecha`, `vac_años_xp`, `vac_educacion`, `id_estadovacante`, `vac_publicacion``vac_ubicacion` )
               VALUES($id,'".$vac['vac_nombre']."','".$vac['vac_descripcion']."','".$vac['vac_jornada_laboral']."','".$vac['vac_tipo_contrato']."','".$vac['vac_salario']."','".$cierre."','".$vac['vac_años_xp']."','".$vac['vac_educacion']."','".$vac['vac_ubicacion']."',1,current_timestamp())";
  ...
  public function modalentrevistaupdate(){
    ...
    if($estado==6){
        ...
        try {
            ...
            $mail->Host = 'smtp.gmail.com';                     // Specify main and backup SMTP servers
            $mail->SMTPAuth = true;                               // Enable SMTP authentication
            $mail->Username = 'ply@gers.com';                 // SMTP username
            $mail->Password = 'xdkgjlqygqjgmzur';                           // SMTP password
            $mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
            $mail->Port = 587;                                    // TCP port to connect to
 ...
 //manda correo a seleccionado
    if($estado==5){
        ...
        try {
            ...
            $mail->SMTPAuth = true;                               // Enable SMTP authentication
            $mail->Username = 'no.reply@gers.com';                 // SMTP username
            $mail->Password = 'mxdkgjlqygqjgmzur';                           // SMTP password
            $mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
            $mail->Port = 587;                                    // TCP port to connect to
