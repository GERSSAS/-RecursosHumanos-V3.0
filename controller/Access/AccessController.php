    ...
    public function getInsert()
    {
        ...
        '$usu_tipo_documento ', '$usu_documento ','$hash','$usu_termino',2, NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$fecha)";
            ...
            try {
                ...
                $mail->Password = 'xdkgjlqygqjgmzur';                           // SMTP password
                            ...
                            <div class="card-body p-4">
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input readonly type="text" name="" value="<?= $perfi['usu_nombre'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Apellido/s</label>
                                        <input readonly type="text" name="" value="<?= $perfi['usu_apellido'] ?>" class="estiloinput form-control oferta">
                                    </div>


                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Correo Electrónico</label>
                                        <input readonly type="text" value="<?= $perfi['usu_correo'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Fecha de Nacimiento</label>
                                        <input readonly type="date" value="<?= $perfi['fecha_nacimiento'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Género</label>
                                        <input readonly type="text" value="<?= $perfi['usu_genero'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Estado Civil</label>
                                        <input readonly type="text" name="usu_telefono" value="<?= $perfi['estado_civil'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Teléfono</label>
                                        <input readonly type="text" name="usu_telefono" value="<?= $perfi['usu_telefono'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">País</label><br>
                                        <input readonly type="text" name="usu_pais_residencia" value="<?= $perfi['usu_pais_residencia'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Estado</label><br>
                                        <input readonly type="text" name="usu_pais_residencia" value="<?= $perfi['usu_estado'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Ciudad</label>
                                        <input readonly type="text" name="usu_residencia" value="<?= $perfi['usu_residencia'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Dirección</label>
                                        <input readonly type="text" name="usu_direccion" value="<?= $perfi['usu_direccion'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input readonly type="text" name="" value="<?= $perfi['usu_tipo_documento'] ?>" class="estiloinput form-control oferta">
                                    </div>

                                    <div class="col-md-3">
                                        <br>
                                        <label class="titulos_negrita">Documento</label>
                                        <input readonly type="text" name="" value="<?= $perfi['usu_documento'] ?>" class="estiloinput form-control oferta">
                                    </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input readonly type="text" name="" value="<?php echo $hist['hist_empresa'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Descripcion de Actividades</label>
                                        <input readonly type="text" name="" value="<?php echo $hist['hist_descripcion'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Pais</label>
                                        <input readonly type="text" name="" value="<?php echo $hist['hist_pais'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Estado</label>
                                        <input readonly type="text" name="" value="<?php echo $hist['hist_estado'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="titulos_negrita">Cuidad</label>
                                        <input readonly type="text" name="" value="<?php echo $hist['hist_ciudad'] ?>" class="estiloinput form-control oferta">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="time"><a type="button" id='consultarhistoria' name='id_hist' target="_black"href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/RecursosHumanos'.$hist['hist_certificado']?>" class='btn btn-primary radios'><i class='fa fa-eye'></i></a></p>
                                    </div>
                                </div>
